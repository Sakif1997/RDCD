...
public class MemberFour extends Methods{
...
//	রুকাইয়া
	...
	public void addMember() throws InterruptedException,  AWTException{
		...
		Thread.sleep(2000);
		FieldValue(jatioPorichoiID_in, "৯০৭৬৭৭৪৪৩৮");
		FieldValue(jonmotarik_in, "22011989");
		FieldValue(NameEnglish_in, "MOMEN");
		FieldValue(NameBangla_in, "মোমেন ");
		FieldValue(FatherName_in, "আবুল");
		...
		Thread.sleep(4000);
		UploadMethod.Upload("E:\\Eclipse Files\\RDCD\\Upload_Images\\4.png");
