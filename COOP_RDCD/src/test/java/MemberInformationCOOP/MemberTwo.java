...
//	রুকাইয়া
	...
	public void addMember() throws InterruptedException,  AWTException{
		...
		Thread.sleep(2000);
		FieldValue(jatioPorichoiID_in, "৯০৭৬৭৭৪৪৩৩");
		FieldValue(jonmotarik_in, "22011989");
		FieldValue(NameEnglish_in, "NILA");
		FieldValue(NameBangla_in, "নিলা");
		FieldValue(FatherName_in, "আব্দুল");
		FieldValue(MotherName_in, "ফাতেমা");
		Thread.sleep(2000);
		FieldValue(MobileName_in, "01523451762");
		FieldValue(MemberApplyDate_in, "01012024");
		clickElement(GenderFeMale_c);
		Thread.sleep(2000);
		...
		Thread.sleep(4000);
		UploadMethod.Upload("E:\\Eclipse Files\\RDCD\\Upload_Images\\2.png");
